      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 flex items-center justify-center">
          <div className="container flex flex-col items-center text-center max-w-3xl">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tighter">Welcome to XPTO Library</h1>
            <p className="mt-4 text-lg text-muted-foreground max-w-[700px]">
              Your gateway to knowledge and imagination
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              <Button className="bg-black text-white hover:bg-black/90">Explore Books</Button>
