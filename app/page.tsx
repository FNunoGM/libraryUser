    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-muted">
          <div className="container flex flex-col items-center text-center">
            <h2 className="text-3xl font-bold tracking-tighter mb-4">Ready to start reading?</h2>
            <p className="max-w-[600px] text-muted-foreground mb-8">
              Create an account to borrow books, save your favorites, and join our community of book lovers.
            </p>
      ...
      <footer className="w-full border-t py-6">
        <div className="container flex flex-col items-center gap-4 text-center">
          <p className="text-sm text-muted-foreground">© 2025 XPTO Library. All rights reserved.</p>
